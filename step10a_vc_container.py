...
if old not in content:
    ...
    with open('index.html', 'w') as f:
        f.write(content)
    print("SUCCESS: vc cards replaced with dynamic container")
